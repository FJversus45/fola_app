                    ...
                    Padding(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          ...
                          auth.userModel.phoneNumber = phoneController.text;
                          auth.userModel.firstName = firstnameController.text;
                          auth.userModel.lastName = lastnameController.text;
                          auth.userModel.gender = gender;
                          auth.userModel.email = emailController.text;
                          Navigator.push(
                            context,
